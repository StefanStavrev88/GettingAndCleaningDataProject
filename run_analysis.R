...
## Bind train/test tables by columns. Bind train and test by rows.
...
## Select only the wanted features/columns. Name feature variables.
...
## Construct final table. Group by subject and activity. Compute feature means.
